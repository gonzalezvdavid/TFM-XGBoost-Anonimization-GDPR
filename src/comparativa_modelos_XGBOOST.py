...
def evaluar_impacto_k_anonimato(df, columnas_modelo, columna_objetivo='isFraud', 
    ...
    modelo = XGBClassifier(n_estimators=100, random_state=random_state, use_label_encoder=False, eval_metric='logloss')
    ...
    for k in valores_k:
        ...
        modelo_anon = XGBClassifier(n_estimators=100, random_state=random_state, use_label_encoder=False, eval_metric='logloss')
